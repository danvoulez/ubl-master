...
- `START-HERE.md` (declarative canonical guardrails)
- `docs/canon/CANON-REFERENCE.md` (exhaustive canon reference)
- `ROLLOUT_P0_TO_P1.md` (rollout sequence)
- `/openapi.json` (OpenAPI 3.1 surface generated by gate runtime)
- `docs/reference/README.md` (official reference sources and paths)
- `SECURITY.md` (signature/verification model)
- `GOVERNANCE.md` (documentation/process governance)
